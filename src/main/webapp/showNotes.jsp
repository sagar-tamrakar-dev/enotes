		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="card mt-3">
					...
					<img alt="" src="img/p4.jpg" class="card-img-top mt-2 mx-auto"
					...
					<div class="card-body p-4">
						...
						<p>
							<b class="text-sucess">Published By:<%= user3.getName()%></b></br> 
						...
						<div class="container text-center mt-2">
							...
							<a href="edit.jsp?note_id=<%=po.getId() %>" class="btn btn-danger">Edit</a>
						</div>
					</div>
				</div>
